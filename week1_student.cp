...
void read_imu()
{
  ...
  imu_data[3]= (float)vw / 32768 * 2 ;// Convert from Raw to "G's"
  ...
  imu_data[4]= (float)vw / 32768 * 2 ;// Convert from Raw to "G's"
  ...
  imu_data[5]= (float)vw / 32768 * 2; // Convert from Raw to "G's"
